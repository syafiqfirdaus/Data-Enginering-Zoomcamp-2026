...
def main():
    ...
    symbols = ["SPY241220C0500", "AAPL240119C0150", "MSFT240119P0300", "TSLA240119C0250", "NVDA240119C0400"]
    
    try:
        while True:
            # Generate fake options trade dynamically
            data = {
                "event_type": "T",
